...
if (myPlayer.checkCollision(p2).collision) {
    collision = true;
    if (myPlayer.checkCollision(p2).position == 1) {
        std::cout << "positon 2" << std::endl;
        myPlayer.acc = myPlayer.yspeed = 0;
    }
    else if (myPlayer.checkCollision(p2).position == 0) {
        std::cout << "positon 0" << std::endl;
        myPlayer.yspeed = 0;
        myPlayer.acc = gravity;
    }
